...
export default function Stack() {
  ...
  return (
    <section id="stack" className="bg-cream-25 vh-75">
      ...
      <div className="d-flex flex-column align-items-center">
        ...
        <div className='d-flex flex-column align-items-center'>
          <h3 className="p-3 fw-light text-center">{textContent.sections.stack.secondary}</h3>

          <div className='w-75 d-flex flex-wrap justify-content-center gap-5 p-3 p-md-5'>
